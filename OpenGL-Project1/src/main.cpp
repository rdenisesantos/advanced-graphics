...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		vertices[3]= value; // adjust value of bottom right vertex (RED)
		vertices[10]=value; // adjust value of bottom left vertex (GREEN)
		vertices[17]=value; // adjust value of top vertex (BLUE)
